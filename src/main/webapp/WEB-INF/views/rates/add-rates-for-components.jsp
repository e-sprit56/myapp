...
<div class="main">
    ...
    <form:form method="post" modelAttribute="Components" action="/app/rateschema/generate-rate-schema">

        <c:forEach items="${Components.componentList}" var="component" varStatus="status">
